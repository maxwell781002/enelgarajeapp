...
import { CompleteBusiness, RelatedBusinessModel, CompleteCategory, RelatedCategoryModel } from "./index"
 ...
 */
export const RelatedPlateModel: z.ZodSchema<CompletePlate> = z.lazy(() => PlateModel.extend({
